...
const TourList = ({ data }) => {
  ...
  // console.log('Params: ', pageId, typeof(pageId));
  ...
  function checkCategory(cate) {
    ...
    useEffect(() => {
      const testData = async () => {
        const res = await axios.get(`https://api.visitjeju.net/vsjApi/contents/searchList?apiKey=uimh6133t6toeyub&locale=kr&category=${category}&page=2`)
